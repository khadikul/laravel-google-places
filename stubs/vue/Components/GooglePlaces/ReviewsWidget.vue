...
defineProps({
  ...
  reviewCount: { type: [Number, null], default: null },
  mapsUrl: { type: [String, null], default: null },
  ...
  <section class="py-10">
    <div class="mb-6 flex flex-wrap items-end justify-between gap-4">
      <div>
        ...
        <Rating v-if="rating !== null" :rating="rating" :count="reviewCount" size="md" class="mt-2" />
      </div>
    ...
    <p v-if="reviews.length === 0" class="text-gray-500 dark:text-gray-400">No reviews to show yet.</p>

    <div v-else class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      <ReviewCard v-for="review in reviews" :key="review.review_name" :review="review" />
    </div>
